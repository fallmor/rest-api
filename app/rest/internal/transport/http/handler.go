...
func (h *Handler) SetupRoutes() {
	...
	// h.Route.HandleFunc("/api", h.HomePage)
...
// 	if r.Method == "GET" {
// 		t, _ := template.ParseFiles("/Users/morfall/Downloads/rest-api/internal/transport/http/forms.gtpl")
// 		t.Execute(w, nil)
// 	} else {
// 		r.ParseForm()
...
// 			Created: time.Now(),
// 		}
// 		com, err := h.Service.PostComment(comment)
// 		fmt.Fprintln(w, com)
// 		if err != nil {
// 			responseErorr(w, err, "Error posting comment")
// 			return
// 		}
// 	}
// }
